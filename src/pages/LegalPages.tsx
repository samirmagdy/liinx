  ...
  return (
    <InformationPage
      ...
      sections={lang === 'ar' ? [
        ...
        ['Agency referral credit', 'A referral qualifies when a new account with a verified email starts a Studio subscription and pays its first invoice. The referrer earns USD $29 in account credit after a 30-day hold, provided the referrer has an active Studio subscription. Credit is automatically applied to a future Liinx invoice through Stripe. The limit is three credits in any 12-month period. Credits are non-cash and non-refundable.'],
