...
1. **Snapshot Generation**:
   ...
   - **Uploads**: Gzip tar archive of user media in `UPLOADS_DIR`.
...
1. Provision a new server instance and mount new persistent volumes for `DATABASE_PATH` and `UPLOADS_DIR`.
