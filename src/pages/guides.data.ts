  ...
  return ar ? [
    {
      ...
      sections: [
        ...
        { title: 'راجع اتجاه الصفحة على الهاتف', body: 'اختر العربية من محدد اللغة في RALOA وعاين الصفحة في اتجاه RTL. راجع ترتيب العناوين والأزرار، واقرأ الروابط كما يراها الزائر قبل النشر.' },
    ...
    },
    {
      ...
      sections: [
        ...
        { title: 'قِس ما يعمل وحدثه', body: 'راجع مشاهدات الصفحة ونقرات الروابط في تحليلات RALOA المتاحة لخُطتك. حدّث ترتيب الروابط عند تغير العروض، ولا تعرض سعراً أو توفر خدمة لم تعد قائمة.' }
      ]
    },
    {
      ...
      sections: [
        ...
        { title: 'أضف وجهة المحادثة بنفسك', body: 'أضف رابط click-to-chat بصيغة https://wa.me/ ثم رقمك بصيغة دولية من دون + أو شرطات. RALOA يعرض الرابط كوجهة قابلة للنقر؛ المحادثة نفسها تُفتح وتُدار داخل WhatsApp.' },
        ...
        { title: 'افصل بين أدوات الصفحة وأدوات البيع', body: 'RALOA ينظم صفحة التعريف والروابط؛ ولا يعالج مدفوعات أو حجوزات WhatsApp. استخدم مزود الدفع أو الحجز الذي تعتمد عليه، ثم اربط وجهته من الصفحة.' }
      ]
    }
  ] : [
    {
      ...
      sections: [
        ...
        { title: 'Review the page in RTL on a phone', body: 'Switch RALOA to Arabic and preview the page in right-to-left layout. Check heading and button order, then read every link as a visitor would before publishing.' },
    ...
    },
    {
      ...
      sections: [
        ...
        { title: 'Measure and keep the page current', body: 'Review page views and link clicks in RALOA analytics where available on your plan. Update link order when offers change, and remove prices or availability that are no longer accurate.' }
      ]
    },
    {
      path: '/guides/whatsapp-business-page',
      ...
      sections: [
        ...
        { title: 'Add your chat destination', body: 'Add a click-to-chat URL in the form https://wa.me/ followed by your number in international format without a plus sign or hyphens. RALOA displays the link as a destination; the conversation opens and is managed in WhatsApp.' },
        ...
        { title: 'Keep page tools separate from sales tools', body: 'RALOA organizes your profile and links; it does not process WhatsApp payments or bookings. Keep using your chosen payment or booking provider, then link to it from the page.' }
      ]
    }
  ]
}
