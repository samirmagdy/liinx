    ...
    <div className="sm:col-span-2 space-y-2 rounded-xl border border-neutral-200 bg-neutral-50 p-3">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg border border-neutral-300 px-2 py-1 text-xs font-semibold hover:border-neutral-900 disabled:cursor-not-allowed disabled:opacity-40"
        >
          {ui('Add item')}
        </button>
      </div>
            ...
            {kind === 'form' && (
              <>
                <input
                  ...
                  maxLength={120}
                  className="rounded-lg border border-neutral-200 px-2 py-1.5 text-xs text-neutral-900"
                />
                <input
                  ...
                  maxLength={64}
                  className="rounded-lg border border-neutral-200 px-2 py-1.5 font-mono text-xs text-neutral-900"
                />
                <select
                ...
                <label htmlFor={`field-required-${item.id || index}`} className="flex items-center gap-2 text-xs text-neutral-700">
                  <input
                ...
                <input
                  ...
                  maxLength={300}
                  className="rounded-lg border border-neutral-200 px-2 py-1.5 text-xs text-neutral-900 sm:col-span-2"
                />
                <label htmlFor={`field-min-len-${item.id || index}`} className="flex items-center gap-1 text-xs text-neutral-700">
                  {ui('Minimum')}
                  <input
                    ...
                    className="w-20 rounded-lg border border-neutral-200 px-2 py-1.5 text-xs text-neutral-900"
                  />
                </label>
                <label htmlFor={`field-max-len-${item.id || index}`} className="flex items-center gap-1 text-xs text-neutral-700">
                  {ui('Maximum')}
                  <input
            ...
            {kind === 'faq' && (
              <>
                ...
                <textarea
                  ...
                  maxLength={5000}
                  className="min-h-24 rounded-lg border border-neutral-200 px-2 py-1.5 text-xs text-neutral-900"
                />
