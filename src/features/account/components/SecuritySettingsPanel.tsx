    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-3xl border border-rose-200 shadow-xs space-y-4 text-start">
        ...
        <div className="space-y-3 max-w-md">
          ...
          <input id="delete-account-password" type="password" autoComplete="current-password" value={props.deletePassword} onChange={event => props.setDeletePassword(event.target.value)} className="w-full px-3.5 py-2 rounded-xl border border-rose-300 text-xs focus:outline-none focus:ring-2 focus:ring-rose-500/20" />
          ...
          <input id="delete-account-confirmation" type="text" value={props.deleteConfirmText} onChange={event => props.setDeleteConfirmText(event.target.value)} placeholder="DELETE" className="w-full px-3.5 py-2 rounded-xl border border-rose-300 text-xs font-mono font-bold text-rose-900 focus:outline-none focus:ring-2 focus:ring-rose-500/20" />
