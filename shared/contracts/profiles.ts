...
export const customThemeSchema = z.object({
  ...
  backgroundImageUrl: mediaUrl.nullable().optional(),
  ...
  shapeStyle: z.enum(['soft', 'organic', 'pill', 'cutout']).optional(),
  profileShape: z.enum(['circle', 'rounded', 'square', 'blob']).optional(),
