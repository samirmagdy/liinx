...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    hero: {
      ...
      headline: 'Give every touchpoint',
      headlineHighlight: 'one beautiful home.',
      subheadline: 'Bring every post, project, booking, and signup into one page your audience can remember—and measure.',
    ...
    templatesSection: {
      ...
      subtitle: 'Start with a live page for your links, media, bookings, and audience—not a blank canvas.',
  ...
  ar: {
    ...
    hero: {
      ...
      headline: 'امنح كل نقطة تواصل',
      headlineHighlight: 'وجهة واحدة جميلة.',
      subheadline: 'اجمع كل منشور ومشروع وحجز واشتراك في صفحة واحدة يتذكرها جمهورك ويمكنك قياسها.',
    ...
    templatesSection: {
      badge: 'معرض القوالب',
      title: 'عاين قبل أن تختار',
      subtitle: 'ابدأ بصفحة حية لروابطك ووسائطك وحجوزاتك وجمهورك، لا بلوحة فارغة.',
